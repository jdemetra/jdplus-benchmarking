...
public class MultivariateChowLinResults implements GenericExplorable {
    ...
    @lombok.NonNull Map<String, TsData> disaggregatedSeries;

    @lombok.NonNull Map<String, TsData> stdevDisaggregatedSeries;
    ...
    @lombok.NonNull TsDomain disaggregationDomain;
