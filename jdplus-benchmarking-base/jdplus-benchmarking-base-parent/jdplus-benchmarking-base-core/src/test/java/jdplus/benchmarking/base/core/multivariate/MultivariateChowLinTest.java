...
//                .var(errVariance)
    ...
    @Test
    public void testMultivariateChowLinRealData2() {
        LinkedHashMap<String, ModelData> yx = new LinkedHashMap<>();
        Map<String, TsData> z = new HashMap<>();

        // Y series
        double[] Y1Arr = {1468.3, 1598.8, 1661.8, 1677.1};
        TsData Y1 = TsData.ofInternal(TsPeriod.yearly(2009), Y1Arr);
        double[] Y2Arr = {10313.5, 9787.9, 11716.6, 12459.2};
        TsData Y2 = TsData.ofInternal(TsPeriod.yearly(2009), Y2Arr);
        double[] Y3Arr = {3512.2, 3333.5, 3551.4, 3971.2};
        TsData Y3 = TsData.ofInternal(TsPeriod.yearly(2009), Y3Arr);
        double[] Y4Arr = {5506.3, 5667, 6330.6, 5280.9};
        TsData Y4 = TsData.ofInternal(TsPeriod.yearly(2009), Y4Arr);
        double[] Y5Arr = {2710.3, 2975.7, 2990, 3045.2};
        TsData Y5 = TsData.ofInternal(TsPeriod.yearly(2009), Y5Arr);
        double[] Y6Arr = {1436.2, 1595.1, 1589.8, 1663.8};
        TsData Y6 = TsData.ofInternal(TsPeriod.yearly(2009), Y6Arr);
        double[] Y7Arr = {15614.6, 15070.4, 16532.6, 16770.2};
        TsData Y7 = TsData.ofInternal(TsPeriod.yearly(2009), Y7Arr);
        double[] Y8Arr = {147, 133.7, 167.5, 180.1};
        TsData Y8 = TsData.ofInternal(TsPeriod.yearly(2009), Y8Arr);
        double[] Y9Arr = {17.4, 22.3, 25.8, 20.6};
        TsData Y9 = TsData.ofInternal(TsPeriod.yearly(2009), Y9Arr);
        double[] Y10Arr = {6088.7, 6145.2, 6986.6, 6819.8};
        TsData Y10 = TsData.ofInternal(TsPeriod.yearly(2009), Y10Arr);
        double[] Y11Arr = {4437.6, 4830.1, 5156.9, 5217.5};
        TsData Y11 = TsData.ofInternal(TsPeriod.yearly(2009), Y11Arr);
        double[] Y12Arr = {355.3, 411.7, 486.5, 595.6};
        TsData Y12 = TsData.ofInternal(TsPeriod.yearly(2009), Y12Arr);

        // indicators
        double[] x1Arr = {30.079, 36.846, 29.488, 52.824, 26.234, 35.189, 27.168, 39.853, 30.186, 36.506, 33.919, 53.853, 32.813, 37.568, 36.185, 51.641};
        TsData[] x1 = {TsData.ofInternal(TsPeriod.quarterly(2009, 1), x1Arr)};
        double[] x2Arr = {47.979, 51.949, 45.541, 68.483, 49.527, 52.296, 47.519, 64.609, 49.858, 59.319, 53.252, 76.664, 55.052, 64.717, 60.247, 71.266};
        TsData[] x2 = {TsData.ofInternal(TsPeriod.quarterly(2009, 1), x2Arr)};
        TsData[] x3 = null;
        double[] x4Arr = {60.458, 62.342, 52.746, 70.278, 53.757, 62.433, 57.16, 83.349, 68.151, 80.289, 71.115, 93.499, 70.384, 75.625, 70.346, 81.923};
        TsData[] x4 = {TsData.ofInternal(TsPeriod.quarterly(2009, 1), x4Arr)};
        double[] x5Arr = {54.575, 60.531, 50.523, 70.906, 60.934, 60.913, 55.221, 76.264, 56.436, 72.225, 61.294, 84.848, 61.136, 72.493, 71.143, 80.693};
        TsData[] x5 = {TsData.ofInternal(TsPeriod.quarterly(2009, 1), x5Arr)};
        TsData[] x6 = null;
        double[] x7Arr = {72.424, 85.151, 68.277, 97.248, 60.694, 68.196, 70.251, 86.918, 67.269, 78.253, 69.574, 99.406, 72.78, 80.158, 70.651, 92.939};
        TsData[] x7 = {TsData.ofInternal(TsPeriod.quarterly(2009, 1), x7Arr)};
        TsData[] x8 = null;
        TsData[] x9 = null;
        double[] x10Arr = {60.287, 61.062, 62.162, 80.548, 52.505, 62.244, 62.621, 85.821, 67.166, 69.844, 66.14, 95.813, 60.522, 71.855, 67.563, 85.243};
        TsData[] x10 = {TsData.ofInternal(TsPeriod.quarterly(2009, 1), x10Arr)};
        double[] x11Arr = {61.197, 64.864, 56.791, 78.483, 61.335, 66.669, 60.78, 87.147, 63.029, 76.776, 66.488, 98.252, 66.16, 77.373, 71.9, 88.045};
        TsData[] x11 = {TsData.ofInternal(TsPeriod.quarterly(2009, 1), x11Arr)};
        TsData[] x12 = null;
        ...
        double[] z1Arr = {12140.194, 12897.196, 11756.701, 14813.309, 11550.619, 12626.825, 12037.928, 15356.028, 12661.023, 14271.712, 13358.694, 16904.67, 13264.538, 14504.131, 13538.246, 16394.285};
        TsData z1 = TsData.ofInternal(TsPeriod.quarterly(2009, 1), z1Arr);
        z.put("z1", z1);
...
//        M2.column(3).set(DoubleSeq.of(new double[] {15.0,16.0,16.7,17.0,15.5,16.5,17.7,18.2}));
    ...
    @Test
    public void testMultivariateChowLin5() {
        ...
        double[] x11Arr = {7,7.2,8.1,7.5,8.5,7.8,8.1,8.4,9.0};
        double[] x12Arr = {18,19.5,19.0,19.7,18.5,19.0,20.3,20.0,21.0};
        TsData[] x1 = {TsData.ofInternal(TsPeriod.quarterly(2021, 1), x11Arr),
                TsData.ofInternal(TsPeriod.quarterly(2021, 1), x12Arr)};
        TsData[] x2 = null;
        double[] x31Arr = {1.5,1.8,2,2.5,2.0,1.5,1.7,2.0,2.5};
        TsData[] x3 = {TsData.ofInternal(TsPeriod.quarterly(2021, 1), x31Arr)};
        ...
        double[] z1Arr = {27.1,29.8,29.9,31.2,29.4,27.9,30.9,31.7,33.0};
        TsData z1 = TsData.ofInternal(TsPeriod.quarterly(2021, 1), z1Arr);
        z.put("z1", z1);
