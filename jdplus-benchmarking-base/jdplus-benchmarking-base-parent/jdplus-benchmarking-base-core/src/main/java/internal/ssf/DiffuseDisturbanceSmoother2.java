 ...
 * @author Jean Palate
 */
public class DiffuseDisturbanceSmoother2 {
    ...
    public static class Builder{
        ...
        public DiffuseDisturbanceSmoother2 build(){
            return new DiffuseDisturbanceSmoother2(ssf, calcVariance, rescaleVariance);
        }
    }
    ...
    private DiffuseDisturbanceSmoother2(ISsf ssf, boolean calcvar, boolean rescalevar){
        this.ssf=ssf;
    ...
    public boolean process(final ISsfData data, @NonNull IDisturbanceSmoothingResults sresults) {
        BaseDiffuseFilteringResults fresults = sqrtFilter(ssf, data, false);
        // rescale the variances
        return process(data.length(), fresults, sresults);
    }

    static DefaultDiffuseSquareRootFilteringResults sqrtFilter(ISsf ssf, ISsfData data, boolean all) {
        ...
        OrdinaryFilter2 filter = new OrdinaryFilter2(initializer);
