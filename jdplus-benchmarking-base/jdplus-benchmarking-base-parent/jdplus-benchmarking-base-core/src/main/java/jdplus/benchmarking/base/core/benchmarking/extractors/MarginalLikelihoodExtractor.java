...
public class MarginalLikelihoodExtractor extends InformationMapping<MarginalLikelihoodStatistics> {


    public MarginalLikelihoodExtractor() {
    ...
    public Class getSourceClass() {
        return MarginalLikelihoodStatistics.class;
    }
