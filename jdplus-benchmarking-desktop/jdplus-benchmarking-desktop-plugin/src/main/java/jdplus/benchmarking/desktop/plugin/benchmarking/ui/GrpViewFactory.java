 ...
 * @author Jean Palate
 */
public class GrpViewFactory extends ProcDocumentViewFactory<GRPDocument> {


     private static final AtomicReference<IProcDocumentViewFactory<GRPDocument>> INSTANCE = new AtomicReference();

    public GrpViewFactory() {
        registerFromLookup(GRPDocument.class);
    }

    public static IProcDocumentViewFactory<GRPDocument> getDefault() {
        IProcDocumentViewFactory<GRPDocument> fac = INSTANCE.get();
        if (fac == null) {
            fac = new GrpViewFactory();
            INSTANCE.lazySet(fac);
        }
        return fac;
    }

    public static void setDefault(IProcDocumentViewFactory<GRPDocument> factory) {
    ...
    public static class InputDataFactory extends ProcDocumentItemFactory<GRPDocument, GRPDocument> {

        public InputDataFactory() {
            super(GRPDocument.class, 
    ...
    public static class BIRatioFactory extends ProcDocumentItemFactory<GRPDocument, GRPDocument> {
    ...
    public static class MainChartFactory extends ProcDocumentItemFactory<GRPDocument, GRPDocument> {
